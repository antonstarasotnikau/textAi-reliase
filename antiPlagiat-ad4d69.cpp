...
int main() {
        system("chcp 1251");
        char text[N] = {"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod eiusmod tempor incididunt sed do eiusmod ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."};
        char fragment[N]; //= {"labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea"};

        cout << "Input fragment for check on plagiat: ";
        cin.getline(fragment, N);

        double plagiate = antiPlagiarism(text, fragment);
        cout << "Text unique on " << plagiate << " percent.";
